...
function App() {
  const steps = [
    ...
    {
      content: `We have known each others for years.
      And somehow, you're always on my mind.
      `,
      image: "/character/two.png",
    },
    {
      content: `With each passing day I realized—yep, I want this girl. For life.
      `,
...
hold your hands, and look into your pretty eyes.`,
  ...
  return (
    <>
      ...
      <div className="bg-[#9932cc] min-h-screen text-white p-5 flex flex-col items-center justify-center max-w-md mx-auto">
        <motion.img
          key={currentStep}
        ...
        {currentStep < 6 && (
          <>
            <button
              ...
              className="bg-white text-[#9932cc] py-3 text-xl rounded-xl w-full mt-10 font-semibold"
            >
              Next
            </button>
            {currentStep > 0 && (
              <button
                onClick={() => setCurrentStep(currentStep - 1)}
                className="bg-white text-[#9932cc] py-3 text-xl rounded-xl w-full mt-2 font-semibold opacity-90"
              >
                Back
              </button>
            )}
        ...
        {currentStep === 6 && (
          <>
            ...
            <button
              ...
              className="bg-white text-[#9932cc] py-3 text-xl rounded-xl w-full mt-2 font-semibold"
            >
              Yes
            </button>
          </>
